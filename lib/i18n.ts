...
export const dictionary = {
  zh: {
    ...
    journal: '独立研究笔记', issue: '第 01 卷 · 2026',
    eyebrow: '从生物学出发，重新阅读人工智能。',
    heroLine1: '阅读智能，', heroLine2: '理解生命系统。',
    intro: '深入阅读正在重塑生物学的论文——从分子结构到可编程细胞。',
    latest: '阅读最新文章', featured: '精选阅读', minutes: '分钟', demo: '示例内容',
    ...
    contentNote: '当前文章与论文为演示内容，可直接替换为你的 Markdown/MDX 笔记。',
  ...
  en: {
    ...
    journal: 'Independent research notes', issue: 'Vol. 01 · 2026',
    eyebrow: 'Artificial intelligence, read through biology.',
    heroLine1: 'Reading intelligence,', heroLine2: 'understanding living systems.',
    intro: 'Deep readings of the papers reshaping biology — from molecular structure to programmable cells.',
    latest: 'Read the latest essay', featured: 'Featured reading', minutes: 'min', demo: 'Demo content',
    ...
    contentNote: 'The current essays and papers are demo content, ready to be replaced with your Markdown/MDX notes.',
