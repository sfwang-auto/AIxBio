...
export const dictionary = {
  zh: {
    ...
    openPaper: '查看论文笔记', researchIndex: '研究索引',
    ...
    tableContents: '本文内容', backArticles: '返回文章', backPapers: '返回论文库',
  ...
  en: {
    ...
    openPaper: 'Open paper note', researchIndex: 'Research index',
    ...
    tableContents: 'In this essay', backArticles: 'Back to essays', backPapers: 'Back to library',
